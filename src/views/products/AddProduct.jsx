...
import { FaUser, FaIdCard, FaUniversity, FaMapMarkerAlt, FaCheckCircle, FaUserPlus } from 'react-icons/fa';
            ...
            <Card.Body className="p-5">
              <Form onSubmit={handleSubmit}>
                <Row>
                  {/* First Column */}
                  <Col md={6}>
                    <FormField icon={FaUser} label="Bank Name" name="name" value={formData.name} onChange={handleChange} />
                    <FormField icon={FaUniversity} label="IFSC Code" name="ifsc_code" value={formData.ifsc_code} onChange={handleChange} />
                  </Col>
                  {/* Second Column */}
                  <Col md={6}>
                    <FormField icon={FaMapMarkerAlt} label="Branch" name="branch" value={formData.branch} onChange={handleChange} />
                    <FormField
                      icon={FaIdCard}
