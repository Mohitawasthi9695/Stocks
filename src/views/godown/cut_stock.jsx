            ...
            try {
                ...
                if (response.data && Array.isArray(response.data)) {
                    const formattedData = response.data.map((item) => ({
                        ...
                        out_length: parseFloat(item.out_length || 0),
                        area: (parseFloat(item.length || 0) * parseFloat(item.width || 0)).toFixed(3),
                        area_sq_ft: (parseFloat(item.length || 0) * parseFloat(item.width || 0) * 10.7639).toFixed(3),
                        status: item.status || 0,
                        cut_stock: Array.isArray(item.cut_stock) ? item.cut_stock : [], // Ensure cut_stock is an array
                    }));
