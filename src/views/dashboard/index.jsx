    ...
    <React.Fragment>
        ...
        {dashStockData.map((data, index) => {
          return (
            <Col key={index} xl={6} xxl={3}>
              <Card>
                <Card.Body style={{
                  background: 'radial-gradient(circle,rgb(30, 223, 248) 0%, hsl(187, 89.10%, 28.80%) 80%)' ,
                  borderRadius: '20px'               
                }}>
                  <h4 className="mb-4 fw-bold">{data.title}</h4>
                  <div className="row d-flex align-items-center">
                    ...
                    <div className="col-3 text-end">
                      <p className="m-b-0 text-white">{data.value}%</p>
                    </div>
                  </div>
      ...
      <Col md={6} xl={8}>
        <Card className="Recent-Users widget-focus-lg">
          <Card.Header style={{
            background: 'linear-gradient(90deg,rgb(166, 167, 173) 0%, rgb(2, 76, 110) 50%, rgb(10, 2, 80) 100%)'
          }}>
            <Card.Title as="h5" style={{
              fontSize: '20px',
              fontWeight: 'bold'
            }}>Recent Supplier</Card.Title>
          </Card.Header>
